        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">海洋散骨サービス</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <a href="tel:0120-123-456" className="flex items-center text-white hover:text-ocean-300 transition-colors">
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                0120-123-456（フリーダイヤル）
              </a>
              <p className="text-gray-400 text-sm">24時間365日受付対応</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li className="text-sm">受付時間：24時間365日</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-8 mb-12">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:0120-123-456" className="bg-ocean-600 text-white px-6 py-3 rounded-sm font-medium hover:bg-ocean-700 transition-colors">
                お電話でのご相談
              </a>
              <button className="border border-gray-600 text-gray-300 px-6 py-3 rounded-sm font-medium hover:bg-gray-700 hover:text-white transition-colors">
                メールでのお問い合わせ
              </button>
            </div>
          </div>
