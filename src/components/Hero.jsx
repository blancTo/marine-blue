    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-max section-padding text-center">
        <div className="max-w-4xl mx-auto">
          {/* メインコピー */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-white leading-tight mb-6 md:mb-8 drop-shadow-lg">
            やすらぎの海へ
            <br />
            <span className="text-ocean-200">心を込めた散骨</span>
          </h1>
          
          <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-12 md:mb-16 max-w-3xl mx-auto drop-shadow-md">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-8 mt-8 sm:mt-12 md:mt-16">
            <div className="bg-white/90 backdrop-blur-sm rounded-md p-3 sm:p-4 md:p-8 shadow-natural border border-white/20">
