...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* 背景グラデーション */}
      <div className="absolute inset-0 bg-gradient-to-br from-powder-100 via-white to-ocean-50"></div>
      ...
      <div className="relative z-10 container-max section-padding text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-body mb-16 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20">
            <a href="#plans" className="btn-primary text-lg">
              料金プランを見る
            </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-natural border border-gray-100/50">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-4 leading-tight">完全サポート</h3>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-natural border border-gray-100/50">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-4 leading-tight">心に寄り添う</h3>
              <p className="text-body text-center">
                ご遺族の想いを大切に、<br />
                一人ひとりに合わせた丁寧な対応
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-natural border border-gray-100/50">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-4 leading-tight">安全運航</h3>
              <p className="text-body text-center">
                経験豊富な船長による<br />
                安心・安全な海上セレモニー
              </p>
