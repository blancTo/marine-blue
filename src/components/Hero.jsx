    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
      ...
      <div className="relative z-10 container-max section-padding text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* CTAボタン */}
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-10 md:mb-14">
          ...
          {/* 特徴カード */}
          <div className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-6 mt-12 sm:mt-16 md:mt-20">
            <div className="bg-white/60 backdrop-blur-sm rounded-md p-3 sm:p-4 md:p-4 shadow-sm border border-white/10">
              ...
              <h3 className="text-xs sm:text-sm md:text-base font-medium text-gray-900 mb-1 sm:mb-2 md:mb-3 leading-tight">完全サポート</h3>
              <p className="text-xs sm:text-xs md:text-base text-gray-700 text-center leading-snug">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-md p-3 sm:p-4 md:p-4 shadow-sm border border-white/10">
              ...
              <h3 className="text-xs sm:text-sm md:text-base font-medium text-gray-900 mb-1 sm:mb-2 md:mb-3 leading-tight">心に寄り添う</h3>
              <p className="text-xs sm:text-xs md:text-base text-gray-700 text-center leading-snug">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-md p-3 sm:p-4 md:p-4 shadow-sm border border-white/10">
              ...
              <h3 className="text-xs sm:text-sm md:text-base font-medium text-gray-900 mb-1 sm:mb-2 md:mb-3 leading-tight">安全運航</h3>
              <p className="text-xs sm:text-xs md:text-base text-gray-700 text-center leading-snug">
