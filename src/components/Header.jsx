      ...
      <div className="container-max px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            <a href="tel:0120-28-3374" className={`hidden sm:flex items-center space-x-2 transition-colors duration-200 ${
              ...
              <span className="text-sm font-medium">0120-28-3374</span>
            </a>
            <button 
          ...
          <div className="md:hidden py-6 border-t border-gray-100 bg-white rounded-b-lg shadow-soft-lg">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="pt-4 border-t border-gray-100">
                <a href="tel:0120-28-3374" className="flex items-center space-x-2 text-ocean-600 font-medium">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span>0120-28-3374</span>
                </a>
              </div>
            </nav>
          </div>
